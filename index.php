...
<html lang="en">
  <head>
    ...
    <title>A vida de Danilo Aparecido</title>
    ...
    <div class="container">
      ...
      <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
        <div class="col-md-6 px-0">
          <h1 class="display-4 font-italic">Danilo Aparecido</h1>
          <p class="lead my-3">
      ...
      <div class="row mb-2">
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              <strong class="d-inline-block mb-2 text-primary">Camiseta</strong>
              <h3 class="mb-0">
                <a class="text-dark" href="#">Camiseta</a>
              </h3>
              ...
              <a href="https://pag.ae/7WRb3vSuu" target="_blank" style="
                ...
                margin-bottom: 20px;
              ">Comprar</a>
              <a href="https://api.whatsapp.com/send?phone=551199999999999&text=Oi%20deu%20problema%20na%20minha%20compra" target="_blank" style="
                  color: green;
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              <strong class="d-inline-block mb-2 text-primary">Caneca</strong>
              <h3 class="mb-0">
                <a class="text-dark" href="#">Caneca</a>
              </h3>
              <div class="mb-1 text-muted">R$ 35,00</div>
              <p class="card-text mb-auto">Caneca do torne-se um programador</p>
              <a href="https://pag.ae/7WRb3vSuu" target="_blank" style="
                font-size: 30px;
                background: #7bef7b;
                display: block;
